...
function Layout({ children }) {
  ...
  const allMenuItems = [
    ...
    // Oculto a propósito: cambios en formularios solo vía desarrollo para evitar inconsistencias en encuestas/respuestas.
    // Si necesitan editar formularios, coordinen con quien administra el sistema.
    // {
    //   path: '/formularios',
    //   label: 'Formularios',
    //   icon: (
  ...
  const menuItems = allMenuItems.filter((item) => {
    ...
    return user?.conexion_role && item.roles.includes(user.conexion_role)
  })
